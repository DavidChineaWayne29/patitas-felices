...
export default function AuthModal({ onClose }) {
  ...
  async function handleSubmit(e) {
    ...
    if (tab === 'login') {
      ...
      if (!form.nombre.trim()) { setError('Escribe tu nombre.'); setLoading(false); return }
        ...
        {ok ? (
          ...
          <>
            ...
            <p className={styles.subtitle}>
              {tab === 'login'
                ? 'Necesitas cuenta para chatear y concertar visitas'
                : 'Es gratis y solo lleva un momento'}
            </p>
