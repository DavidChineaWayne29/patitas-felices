      ...
      <div className={styles.inner}>
        ...
        <div className={styles.brand}>
          <div className={styles.brandRow}>
            ...
            <span className={styles.brandName}>Patitas Felices</span>
          </div>
          ...
          <div className={styles.social}>
            ...
            <a href="https://wa.me/34912345678" target="_blank" rel="noopener noreferrer" className={styles.socialBtn} aria-label="WhatsApp">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
        ...
        <div className={styles.col}>
          <div className={styles.colTitle}>{t('footer.quienesSomosT')}</div>
          <p className={styles.colText}>{t('footer.quienesSomosD')}</p>
        </div>

        <div className={styles.col}>
          <div className={styles.colTitle}>{t('footer.contactoT')}</div>
          <p className={styles.colText}>Calle de los Animales, 24<br/>28001 Madrid</p>
          <a href="tel:+34912345678" className={styles.colLink}>+34 912 345 678</a>
          <a href="mailto:hola@patitasfelices.es" className={styles.colLink}>hola@patitasfelices.es</a>
        </div>
